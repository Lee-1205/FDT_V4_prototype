...
$Run = Join-Path $Root 'runs\fdt_v4_1_424m_transition_20260829_r2'
...
$R1Incident = Join-Path $Root 'artifacts\fdt_v4_1_repair_20260829\transition_r1_mixed_device_grad_check_incident.json'

foreach ($Path in @($Root, $Run, $Python, $Trainer, $Config, $Parent, $BehaviorAudit, $R1Incident)) {
...
$Expected = @{
    $Trainer = 'B84B4DB2ADAB07A61F95926ABC66C7BC718F68F2C1A7AB3397F1AF9E0743D8AF'
    ...
    $R1Incident = '286D5686AF37081D0AB2DAB62D87CF8D421D64D95EAE631F8101DA969813C2A4'
}
...
@{
    ...
    r1_incident = $R1Incident
    r1_incident_sha256 = $Expected[$R1Incident]
